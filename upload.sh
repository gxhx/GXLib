...
cd ~/.cocoapods/repos/GXSpec && git pull origin master && cd - && pod repo push GXSpec ${podSpecName}.podspec --verbose --allow-warnings --use-libraries --skip-import-validation
